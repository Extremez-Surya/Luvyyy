...
class MentionSelectView(LayoutView):
    ...
    async def on_select(self, interaction: discord.Interaction):
        ...
        if selected == "Home":
            ...
            content = (
                "The Founder & Developer Who Created Me. Thank You To Him 💞.\n\n"
                "**The Founder & Developer**\n"
                "**[01]. [Vinay Kumar](https://discord.com/users/731390792567881739)** (`kumar_vinay`)"
            )
        elif selected == "Links":
            bot_id = self.client.user.id if hasattr(self, 'client') and self.client and self.client.user else 1551956534488211581
            content = (
                ...
                "**Developer: [Vinay Kumar](https://discord.com/users/731390792567881739)**"
            )
