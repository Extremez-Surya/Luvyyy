...
class General(commands.Cog):
  ...
  async def invite(self, ctx: commands.Context):
      invite_text = (
          "```Empower your server with blazing-fast features!```\n"
          f"{ZYROXLINKS} **Quick Actions**\n"
          f">>> **[Invite {BotName}](https://discord.com/oauth2/authorize?client_id={self.bot.user.id}&permissions=8&integration_type=0&scope=bot+applications.commands)**\n"
