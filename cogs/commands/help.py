...
import discord
from utils.emoji import ARROWRED, BOOST, CAST, GAMES, LEVEL_UP, LOADINGRED, LOCK, MESSAGE, MUSIC, NEW, PIN, SEED, STAR, SWORD, SYSTEM, THUNDER, TICKET, WIFI, ZAI, ZARROW, ZBAN, ZBOT, ZCIRCLE, ZCIRCLE_ALT1, ZCLOUD, ZCOUNTING, ZMODULE, ZPEOPLE, ZROCKET, ZSAFE, ZTADA, ZUNMUTE, ZWRENCH
...
class HelpCommand(commands.HelpCommand):
  ...
  async def send_bot_help(self, mapping):
    ...
    embed.set_footer(
      text=f"Requested By {self.context.author} | Developed by Vinay Kumar (!Alone💔)",
    )
