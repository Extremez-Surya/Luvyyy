...
class NoPrefix(commands.Cog):
                ...
                for user_id in expired_users:
                    ...
                    f"**Removed By**: **{BotName}**\n"
                        ...
                        support = Button(
                            ...
                            url=f"https://discord.com/users/731390792567881739",
                        )
                        view = View()
    ...
    async def add_np(self, user, duration):
        ...
        embed = CV2Embed(
            ...
            description=f"You've been credited 2 months of global No Prefix for boosting our Partnered Servers. You can now use my commands without prefix. If you wish to remove it, please reach out [Support Server](https://discord.com/users/731390792567881739).",
            color=0xFF0000,
        )
        try:
    ...
    async def remove_np(self, user):
        ...
        embed = CV2Embed(
            ...
            description=f"Hey {user.mention}, your global no prefix has expired!\n\n__**Reason:**__ Unboosting our partnered Server.\nIf you think this is a mistake then please reach out [Support Server](https://discord.com/users/731390792567881739).",
            color=0xFF0000,
        )
